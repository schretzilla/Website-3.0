...
const projectData = [
  ...
  },
  {
    ...
    extraDetails: [],
    tools: ["Raspberry Pi", "RetroPie Image", "A 3D printed enclosure", "Solder & Soldering Iron"],
    team: [],
    date: "March/2019",
    media: {
      type: "image",
  ...
  },
  {
    ...
    team: ["Avery Bodenstein", "Andrew Miyaguchi", "Doug Toperzer", "Michael Uy"],
    date: "October/2018",
    media: {
      type: "video",
  ...
  },
  {
    ...
    extraDetails: [],
    tools: ["ESP32", "Highcharts JS", "A 3D printed egg", "Bluma's CSS Framework"],
  ...
  },
  {
    ...
    extraDetails: [],
    tools: ["D3 v4", "Twitter Bootstrap v3", "AngularJS", "Hosted using Github Pages"],
    team: [],
    date: "January/2017",
    media: {
      type: "image",
